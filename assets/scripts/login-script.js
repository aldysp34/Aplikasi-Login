...
/**
* Membuat variable inputEmailElement untuk tampilan input password.
* @constant {HTMLElement}
*/
...
/**
* Membuat variable expectedEmail untuk menyimpan data email sementara
* @constant {string}
*/
...
/**
* Membuat variable expectedPassword untuk menyimpan data password sementara
* @constant {string}
*/
